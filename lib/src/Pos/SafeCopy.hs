...
import           Pos.Core.Common (AddrAttributes (..), AddrSpendingData (..),
                                  ...
                                  Coin, Currency, CoinPortion (..), Script (..), SharedSeed (..),
...
import           Pos.Core.Txp (Tx (..), TxIn (..), TxInWitness (..), TxOut (..), TxOutAux (..),
                               TxPayload (..), TxProof (..), UserCert(..), SealCert(..), SealState(..))
...
deriveSafeCopySimple 0 'base ''Currency
...
deriveSafeCopySimple 0 'base ''UserCert
deriveSafeCopySimple 0 'base ''SealCert
deriveSafeCopySimple 0 'base ''SealState
